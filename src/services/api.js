...
export const signup = async (signupValues) => {
  ...
  const request = await axios({
    method: 'post',
    url: 'http://localhost:8001/api/user/sign-up',
    data: {
      username,
      email,
      password,
...
export const editUserData = async (userData, token) => {
  const request = await axios({
    method: 'put',
    url: 'http://localhost:8001/api/user/edit',
    headers: {
      Authorization: token,
    },
    data: {
...
export const updateUserData = async (data, token) => {
  ...
  const request = await axios({
    method: 'post',
    url: 'http://localhost:8001/api/user/data/update',
    headers: {
      Authorization: token,
    },
    data: {
...
export const getUserDataRequest = async (token) => {
  ...
  const request = await axios({
    method: 'get',
    url: 'http://localhost:8001/api/user/data/health',
    headers: {
      Authorization: token,
    },
  }).catch(err => err.response);
...
export const generateConsult = async (consult, token, image) => {
  ...
  const request = await axios({
    method: 'post',
    url: 'http://localhost:8001/api/consult/new',
    headers: {
      Authorization: token,
    },
    data: {
...
export const getUserConsults = async (token) => {
  ...
  const request = await axios({
    method: 'get',
    url: 'http://localhost:8001/api/consult/pacient',
    headers: {
      Authorization: token,
    },
  });
...
export const getMedicConsults = async (token) => {
  const request = await axios({
    method: 'get',
    url: 'http://localhost:8001/api/consult/medic',
    headers: {
      Authorization: token,
    },
  });
...
export const getPacientData = async (pacientId, token) => {
  ...
  const request = await axios({
    method: 'get',
    url: `http://localhost:8001/api/consult/medic/pacientData/${pacientId}`,
    headers: {
      Authorization: token,
    },
  }).catch(err => err.response);
...
export const getChatHistory = async (roomId, token) => {
  ...
  const request = await axios({
    method: 'get',
    url: `http://localhost:8001/api/consult/chat/history/${roomId}`,
    headers: {
      Authorization: token,
    },
  }).catch(err => err.response);
